...
const broadThemes = [
  { lottie:"/lottie/ayurveda.json",   title:"Integrative Mental Health Care",       desc:"Bridging traditional Ayurvedic systems with modern psychotherapy, pharmacology, and community-based approaches for holistic care." },
